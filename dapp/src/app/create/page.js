  ...
  return (
    <>
      <div className="container">
        ...
        <p>
          Ao término do cadastro, você receberá o link para divulgá-la e receber
          as doações.
        </p>
        <hr className="mb-4" />
        <div className="col-6">
          ...
          <div className="col-12 mb-3">
            <button type="button" className="btn btn-primary col-12 p-3">
              Salvar
            </button>
          </div>
          <div className="alert alert-success p-3 col-12" role="alert">
